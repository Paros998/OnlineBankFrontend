...
const LoanFinishOrderModal:FC<LoanFinishOrderModalProps> = ({setShowModal,showModal,order,isSubmittingDenied,isSubmittingAccepted,handleSubmit}) => {
      ...
      >
        ...
        <div className='hstack'>
          ...
          <div className='w-60'>
            ...
            {!isPending && <ClientCreditWorthiness clientCreditWorthiness={ClientWorthiness || {} as ClientCreditWorthinessModel} clientLoan={loan}/>}
          </div>
          <div className='w-20'>
