...
interface DeleteClientModalProps extends ModalBasicProps {
}
...
const DeleteClientModal: FC<DeleteClientModalProps> = ({setShowModal, showModal}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(`Usunięto konto klienta pomyślnie!`);
      await fetchData();
    } catch (e: any) {
      ...
      >
        <div className='container-fluid w-100 hstack'>
          ...
          <div className='vstack w-70'>
            ...
            <ClientsRecords Clients={Clients || []} handleClick={handleClick} id={id}
